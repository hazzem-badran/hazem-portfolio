...
const MenuButton = () => {
  ...
  return (
    <>
      <div
        className="absolute right-12 top-8 w-12 h-12 cursor-pointer rounded-full bg-[#E8F9FF] border border-white flex items-center justify-center z-10 transition-opacity duration-500"
        onClick={toggleMenu}
      >
        {isMenuOpen ? (
          <FontAwesomeIcon
